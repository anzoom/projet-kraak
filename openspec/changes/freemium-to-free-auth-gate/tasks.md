...
- [ ] 5.2 Vérifier que `/results` affiche toutes les recommandations pour un utilisateur connecté
- [ ] 5.3 Vérifier que `/results` affiche le nouveau bloc paywall avec le CTA d'inscription pour un utilisateur non connecté
- [ ] 5.4 Vérifier que le clic sur "Je crée mon compte gratuit →" redirige vers `/auth/register`
